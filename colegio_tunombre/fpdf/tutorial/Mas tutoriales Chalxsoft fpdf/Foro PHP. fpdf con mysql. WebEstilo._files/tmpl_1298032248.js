...
{this.imageStyle.itxtSetStyle({width:"0px",height:"0px"});this.imageFailed=true;this.imageLoaded=true;this.reCalculateSize=true;this.properties.width=0;this.properties.height=0;$iTXT.core.$(document).itxtFire("$iTXT:tt:element:loaded",this.advert);},_resize:function(w,h,$super)
{try
{if(this.imageFailed)
{return[0,0];}
if(this.imageLoaded)
...
{var flvstr="";var allowedVars=$iTXT.core.Util.extend(["a","aClr","adx","ar","at","audioUsr","banner","bg","bgc","boc","bt","buc","cc","clickColor","clickPlay","clickURL","clickVarName","cta","cta2","ctac","ctaCase","ctaImg","ctat","cts","fao","hMax","hMin","hqSrc","iPath","k","l1","l2","l3","l4","link1","link2","link3","link4","ll","lMsg","loc","logo","logoH","lqSrc","mpuAudio","mpuBgc","msTrk","msTrk2","mvuData","pageRef","playLim","seid","sest","src","so","t","t1","t2","t3","t4","tBox","tc","tClr","tcol","tD","tl","tracker1","tracker2","trkimg","trueH","trueW","tt","tt1","tt2","tt3","tt4","v8Src","verifyAge","verifyText","vl","webClickURL","webIMG","wMax","wMin","xPanded"],this.properties.vars);var templateFlashVars=this.advert.params.get("templateFlashVars",{});for(var fvName in templateFlashVars)
...
{var opts=e.data||{};if(opts.key&&opts.value)
{try
{var flmc=document.getElementById(this.options.id+"MC");flmc.SetVariable(opts.key,opts.value);}
catch(e)
...
{this.templateBuilt=true;var b=$iTXT.core.Builder;this.rows=[];if(null!=this.structure&&$iTXT.core.Util.isArray(this.structure))
...
{$iTXT.core.$(document).itxtFire("$iTXT:function:fClick");}
window.$iTXT.func={setClickThrough:function(url,did){if(!url.match(/^http/)){return;}
